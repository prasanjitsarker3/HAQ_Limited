...
const AdminSidebar = () => {
  ...
  return (
    <Card className="h-[calc(100vh)] w-full max-w-[13rem] ml-4 p-4 my-4  shadow-xl text-left shadow-blue-gray-900/5">
      ...
      <List className="text-left">
        ...
        <ListItem className="text-left max-w-[10rem] my-1">
          ...
          <Link to="/dashboard/videoBlogPost">Blog Video</Link>
        </ListItem>
