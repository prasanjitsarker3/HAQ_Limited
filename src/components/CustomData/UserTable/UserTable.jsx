      ...
      <Card className="h-full w-full">
                        ...
                        <td className={classes}>
                          <div className="flex items-center gap-3">
                            <Avatar
                              src={
                                user?.image ||
                                "https://img.freepik.com/free-vector/isolated-young-handsome-man-different-poses-white-background-illustration_632498-859.jpg?size=626&ext=jpg&ga=GA1.1.2060036261.1681297115&semt=sph"
                              }
                              alt={name}
                              size="md"
                            />
        ...
        <CardFooter className="flex items-center justify-between border-t border-blue-gray-50 p-4">
          <Typography variant="small" color="blue-gray" className="font-normal">
            Page <span className=" text-blue-700 font-bold">{currentPage}</span>{" "}
            of {totalPages}
          </Typography>
