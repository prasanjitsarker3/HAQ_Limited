...
const CandidateFrom = () => {
    ...
    const administrativeOccupations = [
        ...
        { id: 6, label: 'Administrative Assistant', name: 'Administrative Assistant' },
        ...
        { id: 12, label: 'Customer Service Manager', name: 'Customer Service Manager' },
        { id: 13, label: 'Office Supervisor', name: 'Office Supervisor' },
        { id: 14, label: 'Executive Secretary', name: 'Executive Secretary' },
        { id: 15, label: 'Administrative Coordinator', name: 'Administrative Coordinator' },
    ];
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='px-12 md:w-3/4 mb-12 mx-auto bg-gray-100'>
                <div>
                    ...
                    <div className=' grid md:grid-cols-3 gap-5 pt-3'>
                        <div className=' flex flex-col'>
                            <Input type='text' size="lg" label="Phone Number" {...register('phone', { required: true })} />
                            {errors.phone && <p className='pt-1 text-red-500'>Phone number is required.</p>}
                        </div>
                        <div className=' flex flex-col'>
                            <Input type='date' size="lg" label="Date of Birth" {...register('birthDate', { required: true })} />
                            {errors.birthDate && <p className='pt-1 text-red-500'>Date of birth is required.</p>}
                        </div>
                        <div className=' flex flex-col'>
                            <Input type='file' size="lg" label="Upload Photo" {...register('photo', { required: true })} />
                            {errors.photo && <p className='pt-1 text-red-500'>Photo is required.</p>}
                        </div>
                    </div>
                    <div className='grid md:grid-cols-3 gap-5 pt-5'>
                        <div className="mb-4 flex flex-col">
                            ...
                            {errors.country && <p className="text-red-500 text-sm pt-1">Please select a Country.</p>}
                        </div>
                        <div className="mb-4 flex flex-col">
                            ...
                            {errors.state && <p className="text-red-500 text-sm pt-1">Please select a State.</p>}
                        </div>
                        <div className="mb-4 flex flex-col">
                            <label htmlFor="gender" className="block text-gray-700 text-sm  mb-1">
                                Select City:
                            ...
                            {errors.city && <p className="text-red-500 text-sm pt-1">Please select a State.</p>}
                        </div>
                    ...
                    <div>
                        <h1 className=' text-2xl font-serif font-normal primaryColor'>Education (Add Education)</h1>
                        <div>
                            <div className='grid md:grid-cols-2 gap-5 pt-5'>
                                <div className=' flex flex-col '>
                                    <Input type='text' size="lg" className=' text-lg' label="Institution"  {...register('institution', { required: true })} />
                                    {errors.institution && <p className='pt-1 text-red-500'>Institution is required.</p>}
                                </div>
                                <div className=' flex flex-col '>
                                    <Input type='text' size="lg" className=' text-lg' label="Degree"  {...register('degree', { required: true })} />
                                    {errors.degree && <p className='pt-1 text-red-500'>Degree is required.</p>}
                                </div>
                            </div>
                            <div className='grid md:grid-cols-2 gap-5 pt-5'>
                                <div >
                                    <div className=' flex flex-col pt-3'>
                                        <Input type='date' size="lg" className=' text-lg' label="Started"  {...register('start', { required: true })} />
                                        {errors.start && <p className='pt-1 text-red-500'>Started is required.</p>}
                                    </div>
                                    <div className=' flex flex-col pt-3'>
                                        <Input type='date' size="lg" className=' text-lg' label="Finished"  {...register('finished', { required: true })} />
                                        {errors.finished && <p className='pt-1 text-red-500'>Finished is required.</p>}
                                    </div>
                                </div>
                                <div className=' flex flex-col pt-3'>
                                    <Textarea type='text' size="lg" className=' text-lg' label="Description"  {...register('description', { required: true })} />
                                    {errors.description && <p className='pt-1 text-red-500'>Description is required.</p>}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className='pt-7'>
                        <h1 className=' text-2xl font-serif font-normal primaryColor'>Experience (Add Experience)</h1>
                        <div>
                            <div className='grid md:grid-cols-2 gap-5 pt-5'>
                                <Input type='text' size="lg" className=' text-lg' label="Company Name"  {...register('companyName')} />
                                <Input type='text' size="lg" className=' text-lg' label="Position Title"  {...register('positionTitle')} />

                            </div>
                            <div className='grid md:grid-cols-2 gap-5 pt-5'>
                                <div >
                                    <Input type='date' size="lg" className=' text-lg' label="Started"  {...register('startPosition')} />
                                    <div className='pt-5'>
                                        <Input type='date' size="lg" className=' text-lg' label="Finished"  {...register('finishedPosition')} />
                                    </div>
                                </div>
                                <Textarea type='text' size="lg" className=' text-lg' label="Description"  {...register('descriptionPosition')} />
                            </div>
                        </div>
                    </div>
                    <div className='grid md:grid-cols-2 gap-5 pt-5'>
                        <div>
                            ...
                            <div className=' flex flex-col'>
                                <Input type='text' size="lg" className=' text-lg' label="Professional Headline"  {...register('professional', { required: true })} />
                                {errors.professional && <p className='pt-1 text-red-500'>Professional is required.</p>}
                            </div>
                        </div>
                        <div className=' flex flex-col pt-7'>
                            <Textarea type='text' size="lg" className=' text-lg' label="Profile Summary"  {...register('profile', { required: true })} />
                            {errors.profile && <p className='pt-1 text-red-500'>Profile is required.</p>}
                        </div>
