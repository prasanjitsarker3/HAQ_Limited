    ...
    <div className="pb-12">
      <div>
        <Typography className=" text-2xl text-center py-5 font-serif primaryColor font-medium">
          Registration CompanyFrom
        </Typography>
      </div>
      <form
        onSubmit={handleSubmit(onSubmit)}
        className="px-12 md:w-3/4 mx-auto bg-gray-100 shadow-xl rounded-lg p-3"
      >
        ...
        <div className=" grid md:grid-cols-3 gap-5">
          ...
          <div className=" flex flex-col">
            ...
            />
            {errors.companyName && (
              <p className="pt-1 text-red-500">Company Name is required.</p>
            )}
          </div>
          <div className=" flex flex-col">
            <Input
        ...
        <div className=" grid md:grid-cols-3 gap-5">
          <div className=" flex flex-col">
            ...
            />
            {errors.country && (
              <p className="pt-1 text-red-500">Country is required.</p>
            )}
          </div>
          <div className=" flex flex-col">
            <Input
            ...
            />
            {errors.state && (
              <p className="pt-1 text-red-500">Company State is required.</p>
            )}
          </div>
          <div className=" flex flex-col">
            <Input
