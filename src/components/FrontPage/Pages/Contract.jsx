...
const Contract = () => {
  ...
  return (
    <div>
      <div>
        <h1 className="text-center text-3xl primaryColor py-8  font-serif">
          Contract Us
        </h1>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-5">
        <div className="flex space-y-2 flex-col items-center justify-center w-full md:w-[300px] mx-auto p-5 rounded shadow-sm border border-yellow-900 ">
          <img
            className=" h-12 w-12"
            src="https://cdn-icons-png.flaticon.com/128/9303/9303167.png"
            alt=""
          />
        ...
        <div className="flex space-y-2 flex-col items-center justify-center w-full md:w-[300px] mx-auto p-5 rounded shadow-sm border border-yellow-900 ">
          <img
            className=" h-12 w-12"
            src="https://cdn-icons-png.flaticon.com/128/11511/11511316.png"
            alt=""
          />
          ...
          <h1 className=" flex-1">
            Just Send us your questions or concern by starting a new case and we
        ...
        <div className="flex space-y-2 flex-col items-center justify-center w-full md:w-[300px] mx-auto p-5 rounded shadow-sm border border-yellow-900 ">
          ...
          <Button
            onClick={() => handleOpened("xs")}
            color="blue"
            className="uppercase mt-auto flex  justify-center gap-1"
          >
            Start chat <FaFacebookMessenger />{" "}
          </Button>
          <Dialog
            open={size === "xs"}
            size={size || "md"}
          ...
          >
            ...
            <DialogBody>
              <Typography className=" text-right text-blue-600">
                Hello
              </Typography>
              <Typography className=" text-right text-blue-600">
                How can i help you?
              </Typography>
              <Typography className="text-blue-600 text-left">
                {data}
              </Typography>
              {chat && (
                <Typography className=" text-right text-blue-600">
              ...
              <div className=" flex justify-start mr-5 mt-2">
                <input
                  className="border-white rounded p-1 bg-blue-gray-50"
                  ref={message}
                  placeholder="typing..."
                />
                {user ? (
                  <FaRegCommentDots
                    ...
                    className="text-blue-600 mt-1  cursor-pointer w-6 h-6"
                  />
                ) : (
                  <Link to="/login">
      ...
      <div className="flex flex-col md:flex-row  gap-12 px-16 py-12">
        ...
        <div className="w-full md:w-1/2 ">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d912.7471018198211!2d90.42534153979757!3d23.783427146331693!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c7e8b1ec3971%3A0x4eeaac0820774865!2sMisal%20International!5e0!3m2!1sen!2sbd!4v1697215687910!5m2!1sen!2sbd"
          ></iframe>
        </div>
      </div>
    </div>
